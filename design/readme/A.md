<div align="center">
<img src="https://raw.githubusercontent.com/allisonmahmood/blockyard/main/assets/blockyard.svg" alt="Blockyard icon" width="64" height="64">
...
[Download for Omarchy](https://github.com/allisonmahmood/blockyard/releases/latest) · [Documentation](https://github.com/allisonmahmood/blockyard/blob/main/docs/architecture.md) · [Report a bug](https://github.com/allisonmahmood/blockyard/issues)

</div>

![Blockyard showing a nested disk map and the size of a selected cache folder](https://raw.githubusercontent.com/allisonmahmood/blockyard/a6bfbb0/design/readme/screenshots/dark-hero.png)
...
![The same Blockyard view using the Catppuccin Latte light theme](https://raw.githubusercontent.com/allisonmahmood/blockyard/a6bfbb0/design/readme/screenshots/light-hero.png)
...
![The review dialog lists the exact selected path before offering Trash or permanent removal](https://raw.githubusercontent.com/allisonmahmood/blockyard/a6bfbb0/design/readme/screenshots/dark-review.png)

</details>

Trash usually retains disk space until emptied. Selected bytes can also differ from space freed because of snapshots or shared data. [Read how cleanup works](https://github.com/allisonmahmood/blockyard/blob/main/docs/engine.md).
